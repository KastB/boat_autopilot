...
void setup() {
  ...
  TCCR4A = (TCCR4A & 0b11111100) |
           0b10;  // Phase and Frequency correct => three last bits of 1001
  TCCR4B = (TCCR4B & 0b11100000) |
           0b10001;  // First bit of 1001 and 010 for divisor of 1
